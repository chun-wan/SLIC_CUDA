...
private:
	...
	//cudaArray
	hipArray* cuArrayFrameBGRA;
	hipArray* cuArrayFrameLab;
	hipArray* cuArrayLabels;

	// Texture and surface Object
	hipTextureObject_t oTexFrameBGRA;
	hipSurfaceObject_t oSurfFrameLab;
	hipSurfaceObject_t oSurfLabels;
