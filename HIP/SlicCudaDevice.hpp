...
__global__ void kRgb2CIELab(const hipTextureObject_t inputImg,
							hipSurfaceObject_t outputImg,
							int width,
							int height);

__global__ void kInitClusters(const hipSurfaceObject_t frameLab, 
								float* clusters, 
								int width, 
								int height, 
								int nSpxPerRow, 
...
__global__ void kAssignment(const hipSurfaceObject_t frameLab,
